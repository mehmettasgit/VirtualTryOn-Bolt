...
const PhotoUploader: React.FC<PhotoUploaderProps> = ({ 
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
      <label htmlFor="portrait-upload" className="block text-lg font-semibold text-gray-800 mb-4">
      ...
      <div
        className={`
          ...
          ${isDragOver && !disabled ? 'border-indigo-500 bg-indigo-50' : 'border-gray-300'}
      ...
      >
        <input
          ...
          className="hidden"
          disabled={disabled}
          aria-describedby="portrait-upload-description"
        />
        ...
        {previewUrl ? (
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p id="portrait-upload-description" className="text-sm text-gray-500 mt-1">
                Drag and drop or click to select a full-body image
              </p>
            </div>
          </div>
        )}
